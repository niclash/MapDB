...
public class SerializerPojoTest extends TestCase
{
    ...
    private byte[] serialize( Object i )
        throws IOException
    {
    ...
    public void testGetFieldValue1()
        throws Exception
    {
    ...
    public void testPersistedSimple()
        throws Exception
    {

        File f = UtilsTest.tempDbFile();
        DB r1 = DBMaker.newFileDB( f ).make();
        long recid = r1.getEngine().put( "AA", r1.getDefaultSerializer() );
        r1.commit();
        r1.close();

        r1 = DBMaker.newFileDB( f ).make();

        String a2 = (String) r1.getEngine().get( recid, r1.getDefaultSerializer() );
        r1.close();
        assertEquals( "AA", a2 );
    }
        ...
        throws Exception
    {
        ...
        File f = UtilsTest.tempDbFile();
        DB r1 = DBMaker.newFileDB( f ).make();
        long recid = r1.getEngine().put( b1, r1.getDefaultSerializer() );
        r1.commit();
        r1.close();

        r1 = DBMaker.newFileDB( f ).make();

        Bean1 b2 = (Bean1) r1.getEngine().get( recid, r1.getDefaultSerializer() );
        r1.close();
        assertEquals( b1, b2 );
    }
    ...
    public void test_write_object_advanced_serializationm()
    {
        ...
        for( Object oo : o )
        {
            ...
            long recid = db.getEngine().put( oo, db.getDefaultSerializer() );
            assertEquals( oo, db.getEngine().get( recid, db.getDefaultSerializer() ) );
        }
    }
...
//        System.out.println(((SerializerPojo)db.defaultSerializer).registered);
        ...
        throws UnknownHostException
    {
        ...
        long recid = db.getEngine().put( value, db.getDefaultSerializer() );
        Object value2 = db.getEngine().get( recid, db.getDefaultSerializer() );
