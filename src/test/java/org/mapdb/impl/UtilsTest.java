...
public class UtilsTest
{
    ...
    {
        assertEquals( asList( 1, 2, 3, 4, 5 ), asList( BTreeMapImpl.arrayPut( new Integer[]{ 1, 2, 4, 5 }, 2, 3 ) ) );
        assertEquals( asList( 1, 2, 3, 4, 5 ), asList( BTreeMapImpl.arrayPut( new Integer[]{ 2, 3, 4, 5 }, 0, 1 ) ) );
        assertEquals( asList( 1, 2, 3, 4, 5 ), asList( BTreeMapImpl.arrayPut( new Integer[]{ 1, 2, 3, 4 }, 4, 5 ) ) );
    }
     ...
     */
    public static <E> E clone( E value, ValueSerializer<E> serializer )
    {
        try
        {
            DataOutput2 out = new DataOutput2();
    ...
    public static ValueSerializer FAIL = new ValueSerializer()
    {
        @Override
        ...
        @Override
        public Object deserialize( DataInput in, int available )
            throws IOException
        {
            throw new RuntimeException();
        }
