...
public class HTreeSetTest
{
    ...
    public void init()
    {
        ...
        hs = new HTreeMapImpl( engine, 0, 0, HTreeMapImpl.preallocateSegments( engine ), SerializerBase.BASIC, null, 0, 0, 0, 0, 0, null, null, null, null, false )
            .keySet();
    ...
    public void test_Constructor()
    {
        ...
        Set hs2 = new HTreeMapImpl( engine, 0, 0, HTreeMapImpl.preallocateSegments( engine ), SerializerBase.BASIC, null, 0, 0, 0, 0, 0, null, null, null, null, false )
            .keySet();
    ...
    public void test_isEmpty()
    {
        ...
        assertTrue( "Empty set returned false", new HTreeMapImpl( engine, 0, 0, HTreeMapImpl.preallocateSegments( engine ), SerializerBase.BASIC, null, 0, 0, 0, 0, 0, null, null, null, null, false )
            .keySet()
            .isEmpty() );
