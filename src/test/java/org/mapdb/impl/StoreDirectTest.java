...
import static org.mapdb.impl.StoreDirect.LAST_RESERVED_RECID;
import static org.mapdb.impl.StoreDirect.LONG_STACK_PREF_SIZE;
import static org.mapdb.impl.StoreDirect.MASK_LINKED;
import static org.mapdb.impl.StoreDirect.MASK_OFFSET;
import static org.mapdb.impl.StoreDirect.MAX_REC_SIZE;
import static org.mapdb.impl.StoreDirect.size2ListIoRecid;
...
public class StoreDirectTest<E extends StoreDirect> extends EngineTest<E>
{
    ...
    {
        long recid = e.put( 1000L, SerializerBase.LONG );
        e.commit();
        assertEquals( 1, countIndexRecords() );
        e.delete( recid, SerializerBase.LONG );
        e.commit();
    ...
    public void test_index_record_delete_and_reusef()
    {
        ...
        e.commit();
        assertEquals( 0, countIndexRecords() );
        long recid2 = e.put( 1000L, SerializerBase.LONG );
        e.commit();
    ...
    public void test_index_record_delete_and_reuse_large()
    {
        ...
        for( int i = 0; i < MAX; i++ )
        {
            recids.add( e.put( 0L, SerializerBase.LONG ) );
        }
        ...
        for( int i = 0; i < MAX; i++ )
        {
            recids2.add( e.put( 0L, SerializerBase.LONG ) );
        }
    ...
    {
        final long recid = e.put( 1L, SerializerBase.LONG );
        assertEquals( (Long) 1L, e.get( recid, SerializerBase.LONG ) );
        final long physRecid = e.index.getLong( recid * 8 + StoreDirect.IO_USER_START );
        e.delete( recid, SerializerBase.LONG );
        final long recid2 = e.put( 1L, SerializerBase.LONG );
        assertEquals( (Long) 1L, e.get( recid2, SerializerBase.LONG ) );
    ...
    @Test
    public void test_index_stores_record_size()
        throws IOException
    {
        final long recid = e.put( 1, SerializerBase.INTEGER );
        e.commit();
        assertEquals( 4, e.index.getUnsignedShort( recid * 8 + StoreDirect.IO_USER_START ) );
        assertEquals( Integer.valueOf( 1 ), e.get( recid, SerializerBase.INTEGER ) );

        e.update( recid, 1L, SerializerBase.LONG );
        e.commit();
        assertEquals( 8, e.index.getUnsignedShort( recid * 8 + StoreDirect.IO_USER_START ) );
        assertEquals( Long.valueOf( 1 ), e.get( recid, SerializerBase.LONG ) );
    }

    @Test
    public void test_long_stack_puts_record_offset_into_index()
        throws IOException
    {
        e.structuralLock.lock();
    ...
    @Test
    public void test_long_stack_put_take()
        throws IOException
    {
        e.structuralLock.lock();
    ...
    @Test
    public void test_long_stack_put_take_simple()
        throws IOException
    {
        e.structuralLock.lock();
    ...
    @Test
    public void test_basic_long_stack()
        throws IOException
    {
    ...
    @Test
    public void test_large_long_stack()
        throws IOException
    {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
    ...
    @Test
    public void test_basic_long_stack_no_commit()
        throws IOException
    {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
    ...
    @Test
    public void test_large_long_stack_no_commit()
        throws IOException
    {
        //dirty hack to make sure we have lock
        e.structuralLock.lock();
    ...
    @Test
    public void long_stack_page_created_after_put()
        throws IOException
    {
        e.structuralLock.lock();
        e.longStackPut( IO_RECID, 111, false );
    ...
    @Test
    public void long_stack_put_five()
        throws IOException
    {
        e.structuralLock.lock();
        e.longStackPut( IO_RECID, 111, false );
    ...
    @Test
    public void long_stack_page_deleted_after_take()
        throws IOException
    {
        e.structuralLock.lock();
        e.longStackPut( IO_RECID, 111, false );
    ...
    @Test
    public void long_stack_page_overflow()
        throws IOException
    {
        e.structuralLock.lock();
    ...
    public void freeSpaceWorks()
    {
        ...
        long recid = e.put( new byte[ 10000 ], SerializerBase.BYTE_ARRAY_NOSIZE );
        e.commit();
        assertEquals( oldFree, e.getFreeSize() );
        e.delete( recid, SerializerBase.BYTE_ARRAY_NOSIZE );
    ...
    @Test
    public void header_index_inc()
        throws IOException
    {
        e.put( new byte[ 10000 ], SerializerBase.BYTE_ARRAY_NOSIZE );
        e.commit();
        e.close();
