...
//        vals.iterator();
     ...
     */
    public void test_pollFirstEntry()
        throws Exception
    {
        Integer testint = new Integer( -1 );
        Integer testint10000 = new Integer( -10000 );
     ...
     */
    public void test_pollLastEntry()
        throws Exception
    {
        Integer testint10000 = new Integer( 10000 );
        Integer testint9999 = new Integer( 9999 );
...
//        assertNull(tm.higherKey(null));
    ...
    public void test_navigableKeySet()
        throws Exception
    {
        Integer testint9999 = new Integer( 9999 );
        Integer testint10000 = new Integer( 10000 );
...
//        }
    ...
    public void test_descendingMap_subMap()
        throws Exception
    {
    ...
    public void test_remove_from_iterator()
        throws Exception
    {
        Set set = tm.keySet();
        Iterator iter = set.iterator();
