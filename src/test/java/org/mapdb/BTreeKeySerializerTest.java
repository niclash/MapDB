...
public class BTreeKeySerializerTest
{
    ...
    final BTreeKeySerializer.Tuple2KeySerializer tuple2_serializer = new BTreeKeySerializer.Tuple2KeySerializer(
        BTreeMapImpl.COMPARABLE_COMPARATOR,
        SerializerBase.BASIC, SerializerBase.BASIC );

    @Test
    public void tuple2_simple()
        throws IOException
    {
    ...
    final BTreeKeySerializer.Tuple3KeySerializer tuple3_serializer = new BTreeKeySerializer.Tuple3KeySerializer(
        BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR,
        SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC );

    @Test
    public void tuple3_simple()
        throws IOException
    {
    ...
    final BTreeKeySerializer.Tuple4KeySerializer tuple4_serializer = new BTreeKeySerializer.Tuple4KeySerializer(
        BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR,
        SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC );

    @Test
    public void tuple4_simple()
        throws IOException
    {
    ...
    final BTreeKeySerializer.Tuple5KeySerializer tuple5_serializer = new BTreeKeySerializer.Tuple5KeySerializer(
        BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR,
        SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC );

    @Test
    public void tuple5_simple()
        throws IOException
    {
    ...
    final BTreeKeySerializer.Tuple6KeySerializer tuple6_serializer = new BTreeKeySerializer.Tuple6KeySerializer(
        BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR, BTreeMapImpl.COMPARABLE_COMPARATOR,
        SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC, SerializerBase.BASIC );

    @Test
    public void tuple6_simple()
        throws IOException
    {
