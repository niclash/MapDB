...
public class TestTransactions
{
    ...
    @Test
    public void testSameCollectionInsertDifferentValuesInDifferentTransactions()
        throws Exception
    {
        ...
        tx1.commit();
        System.out.println( "tx1 commit succeeded, map size after tx1 commits: " + txMaker.makeTx()
            .getTreeMap( "testMap" )
            .size() );
    ...
    @Test
    public void testDifferentCollectionsInDifferentTransactions()
        throws Exception
    {
    ...
    @Test
    public void testSameCollectionModifyDifferentValuesInDifferentTransactions()
        throws Exception
    {
    ...
    @Test
    public void testTransactionsDoingNothing()
        throws Exception
    {
