...
public class PumpTest {
    ...
    @Test public void presort(){
        ...
        Iterator<Integer> sorted = Pump.sort(list.iterator(),false, max/20,
                Fun.COMPARATOR_NON_NULL, Serializer.INTEGER);
    ...
    @Test public void uuid_reversed(){
        ...
        Set<UUID> sorted = new TreeSet<UUID>(Collections.reverseOrder(Fun.COMPARATOR_NON_NULL));
        sorted.addAll(u);

        Iterator<UUID> iter = u.iterator();
        iter = Pump.sort(iter,false, 10000,Collections.reverseOrder(Fun.COMPARATOR_NON_NULL),Serializer.UUID);
    ...
    @Test public void duplicates_reversed(){
        ...
        Comparator c = Collections.reverseOrder(Fun.COMPARATOR_NON_NULL);
