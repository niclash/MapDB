...
public class Issue332Test
{
    ...
    public static final CompressionWrapper<String> VALUE_SERIALIZER = new CompressionWrapper<String>( new TestSerializer() );

    public static final class TestSerializer implements ValueSerializer<String>, Serializable
    {
