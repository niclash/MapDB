...
public class DBTest
{
        ...
        throws Exception
    {
        ...
        assertEquals( m1, new DbImpl( engine ).getHashMap( "test" ) );
    }
        ...
        throws Exception
    {
        ...
        assertEquals( m1, new DbImpl( engine ).getHashSet( "test" ) );
    }
        ...
        throws Exception
    {
        ...
        assertEquals( m1, new DbImpl( engine ).getTreeMap( "test" ) );
    }
        ...
        throws Exception
    {
        ...
        assertEquals( m1, new DbImpl( engine ).getTreeSet( "test" ) );
    }
