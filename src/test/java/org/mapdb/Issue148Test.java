...
public class Issue148Test
{
    ...
    public void repeated_update()
    {
        ...
        long recid = engine.put( str, SerializerBase.STRING_NOSIZE );
        engine.commit();
        engine.close();
        ...
        for( int i = 10; i < 100; i++ )
        {
            ...
            assertEquals( str, engine.get( recid, SerializerBase.STRING_NOSIZE ) );
        ...
        throws IOException
    {
        ...
        ValueSerializer<CustomValue> valueSerializer = new CustomValueSerializer();
    ...
    public static class CustomValueSerializer implements ValueSerializer<CustomValue>, Serializable
    {

        private static final long serialVersionUID = -6987588810823227467L;

        public void serialize( DataOutput out, CustomValue value )
            throws IOException
        {
