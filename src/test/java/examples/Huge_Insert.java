...
public class Huge_Insert
{
        ...
        throws IOException
    {
        ...
        source = Pump.sort( source,
                            true, 100000,
                            Collections.reverseOrder( BTreeMapImpl.COMPARABLE_COMPARATOR ), //reverse  order comparator
         ...
         */
        KeySerializer<String> keySerializer = BTreeKeySerializer.STRING;
        ...
        System.out.println( "Finished; total time: " + ( System.currentTimeMillis() - time ) / 1000 + "s; there are " + map
            .size() + " items in map" );
        db.close();
    }
