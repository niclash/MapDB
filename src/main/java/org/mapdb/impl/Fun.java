...
public final class Fun
{
    ...
    public static final class Tuple6Comparator<A, B, C, D, E, F> implements Comparator<Tuple6<A, B, C, D, E, F>>, Serializable
    {
        ...
        public Tuple6Comparator( Comparator<A> a,
                                 Comparator<B> b,
                                 Comparator<C> c,
                                 Comparator<D> d,
                                 Comparator<E> e,
        ...
        public boolean equals( Object o )
        {
            ...
            return a.equals( that.a ) && b.equals( that.b ) && c.equals( that.c ) && d.equals( that.d ) && e.equals( that.e ) && f
                .equals( that.f );
        }
     ...
     * and {@link org.mapdb.Bind#secondaryKey(org.mapdb.Bind.MapWithModificationListener, java.util.Set, Fun.Function2)}
    ...
    public static <A, B, C, D> Iterable<D> filter( final NavigableSet<Fun.Tuple4<A, B, C, D>> secondaryKeys,
                                                   final A a,
                                                   final B b,
                                                   final C c
    )
    ...
    {
        boolean run( final long recid, final A value, final ValueSerializer<A> serializer );
    }
    ...
    {
        @Override
        public boolean run( long recid, Object value, ValueSerializer serializer )
        {
            return true;
        }
    };
