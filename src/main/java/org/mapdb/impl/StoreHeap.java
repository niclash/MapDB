...
public class StoreHeap extends Store implements Serializable{
    ...
    public StoreHeap(boolean disableLocks){
        ...
        for(long recid=1;recid<=LAST_RESERVED_RECID;recid++){
            records.put(recid, Fun.t2(null, (ValueSerializer)null));
        }
    }
    ...
    public <A> long put(A value, ValueSerializer<A> serializer) {
        ...
        try{
            Long recid = freeRecids.poll();
            if(recid==null) recid = maxRecid.incrementAndGet();
            records.put(recid, Fun.<Object, ValueSerializer>t2(value,serializer));
    ...
    public <A> void update(long recid, A value, ValueSerializer<A> serializer) {
        ...
        try{
            Fun.Tuple2 old = records.put(recid, Fun.<Object, ValueSerializer>t2(value,serializer));
    ...
    public ByteBuffer getRaw(long recid) {
        ...
        return ByteBuffer.wrap(serialize(t.a, (ValueSerializer<Object>) t.b).copyBytes());
    }
