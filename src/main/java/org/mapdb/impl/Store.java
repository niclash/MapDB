...
public abstract class Store implements Engine
{
    ...
    protected <A> DataOutput2 serialize(A value, ValueSerializer<A> serializer){
        try {
            ...
            if(out.pos>0){
                ...
                if(CC.PARANOID)try{
                    ...
                    byte[] decompress = deserialize( SerializerBase.BYTE_ARRAY_NOSIZE,out.pos,inp);
    ...
    protected <A> A deserialize(ValueSerializer<A> serializer, int size, DataInput input) throws IOException {
