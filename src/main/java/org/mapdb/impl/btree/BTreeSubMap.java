...
class BTreeSubMap<K, V> extends AbstractMap<K, V> implements ConcurrentNavigableMap<K, V>
{
    ...
    public BTreeSubMap( BTreeMapImpl<K, V> m, K lo, boolean loInclusive, K hi, boolean hiInclusive )
    {
        this.m = m;
        this.lo = lo;
...
/* ----------------  Map API methods -------------- */
     ...
     */
    private BTreeSubMap<K, V> newSubMap( K fromKey,
...
//            }
        ...
        return new BTreeSubMap<K, V>( m, fromKey, fromInclusive,
                                 toKey, toInclusive );
    }

    @Override
    public BTreeSubMap<K, V> subMap( K fromKey,
                                boolean fromInclusive,
                                K toKey,
                                boolean toInclusive
    )
    ...
    @Override
    public BTreeSubMap<K, V> headMap( K toKey,
                                 boolean inclusive
    )
    {
        if( toKey == null )
    ...
    @Override
    public BTreeSubMap<K, V> tailMap( K fromKey,
                                 boolean inclusive
    )
    {
        if( fromKey == null )
    ...
    @Override
    public BTreeSubMap<K, V> subMap( K fromKey, K toKey )
    {
    ...
    {
        return new BTreeDescendingMap( m, lo, loInclusive, hi, hiInclusive );
    }
    ...
    {
        return new BTreeDescendingMap<K, V>( m, lo, loInclusive, hi, hiInclusive ).keySet();
    }
