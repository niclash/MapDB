...
public class SerializerBase implements ValueSerializer<Object>
{
     ...
     */
    public static final ValueSerializer<String> STRING = new StringValueSerializer();
    /**
     * Serializes strings using UTF8 encoding.
     ...
     * Does not handle null values
     */
    public static final ValueSerializer<String> STRING_INTERN = new StringInternValueSerializer();
    /**
     ...
     * Does not handle null values
     */
    public static final ValueSerializer<String> STRING_ASCII = new StringAsciiValueSerializer();
    /**
     * Serializes strings using UTF8 encoding.
     * Used mainly for testing.
     * Does not handle null values.
     */
    public static final ValueSerializer<String> STRING_NOSIZE = new StringNoSizeValueSerializer();
    /** Serializes Long into 8 bytes, used mainly for testing.
     * Does not handle null values.*/

    public static final ValueSerializer<Long> LONG = new LongValueSerializer();
    /** Serializes Integer into 4 bytes.
     * Does not handle null values.*/

    public static final ValueSerializer<Integer> INTEGER = new IntegerValueSerializer();
    public static final ValueSerializer<Boolean> BOOLEAN = new BooleanValueSerializer();
    /**
     * Always throws {@link IllegalAccessError} when invoked. Useful for testing and assertions.
     */
    public static final ValueSerializer<Object> ILLEGAL_ACCESS = new IllegalAccessValueSerializer();
    /**
     ...
     */
    public static final ValueSerializer<byte[] > BYTE_ARRAY = new ByteValueSerializer();
    /**
     * Serializes `byte[]` directly into underlying store
     * It does not store size, so it can not be used in Maps and other collections.
     */
    public static final ValueSerializer<byte[] > BYTE_ARRAY_NOSIZE = new ByteArrayValueSerializer();
    /**
     * Serializes `char[]` it adds header which contains size information
     */
    public static final ValueSerializer<char[] > CHAR_ARRAY = new CharArrayValueSerializer();
    /**
     * Serializes `int[]` it adds header which contains size information
     */
    public static final ValueSerializer<int[] > INT_ARRAY = new IntArrayValueSerializer();
    /**
     * Serializes `long[]` it adds header which contains size information
     */
    public static final ValueSerializer<long[] > LONG_ARRAY = new LongArrayValueSerializer();
    /**
     * Serializes `double[]` it adds header which contains size information
     */
    public static final ValueSerializer<double[] > DOUBLE_ARRAY = new DoubleArrayValueSerializer();
    ...
    public static final ValueSerializer<Object> JAVA = new JavaValueSerializer();
    /** Serializers {@link java.util.UUID} class */
    public static final ValueSerializer<java.util.UUID> UUID = new UuidValueSerializer();
    ...
    protected static final class singletons{
        ...
        static {
            ...
            all.put( BTreeMapImpl.COMPARABLE_COMPARATOR,HeaderMapDB.COMPARABLE_COMPARATOR);
            ...
            all.put( STRING_NOSIZE,HeaderMapDB.SERIALIZER_STRING_NOSIZE);
            all.put( STRING_ASCII,HeaderMapDB.SERIALIZER_STRING_ASCII);
            all.put( STRING_INTERN,HeaderMapDB.SERIALIZER_STRING_INTERN);
            all.put( LONG,HeaderMapDB.SERIALIZER_LONG);
            all.put( INTEGER,HeaderMapDB.SERIALIZER_INT);
            all.put( ILLEGAL_ACCESS,HeaderMapDB.SERIALIZER_ILLEGAL_ACCESS);
            all.put( BASIC,HeaderMapDB.SERIALIZER_BASIC);
            all.put( BOOLEAN,HeaderMapDB.SERIALIZER_BOOLEAN);
            all.put( BYTE_ARRAY_NOSIZE,HeaderMapDB.SERIALIZER_BYTE_ARRAY_NOSIZE);
            all.put( BYTE_ARRAY,HeaderMapDB.BYTE_ARRAY_SERIALIZER);
            all.put( JAVA,HeaderMapDB.SERIALIZER_JAVA);
            all.put( UUID,HeaderMapDB.SERIALIZER_UUID);
            all.put( STRING,HeaderMapDB.SERIALIZER_STRING);
            all.put( CHAR_ARRAY,HeaderMapDB.SERIALIZER_CHAR_ARRAY);
            all.put( INT_ARRAY,HeaderMapDB.SERIALIZER_INT_ARRAY);
            all.put( LONG_ARRAY,HeaderMapDB.SERIALIZER_LONG_ARRAY);
            all.put( DOUBLE_ARRAY,HeaderMapDB.SERIALIZER_DOUBLE_ARRAY);
