...
public class HTreeMapImpl<K, V> extends AbstractMap<K, V> implements HTreeMap<K,V>
{
    ...
    protected final ValueSerializer<K> keySerializer;
    ...
    protected final ValueSerializer<LinkedNode<K, V>> LN_SERIALIZER = new ValueSerializer<LinkedNode<K, V>>()
    {
        @Override
        public void serialize( DataOutput out, LinkedNode<K, V> value )
            throws IOException
        {
        ...
        @Override
        public LinkedNode<K, V> deserialize( DataInput in, int available )
            throws IOException
        {
            assert ( available != 0 );
            return new LinkedNode<K, V>(
                ...
                hasValues ? valueSerializer.deserialize( in, -1 ) : (V) BTreeMapImpl.EMPTY
            );
        }
    ...
    protected static final ValueSerializer<long[][]> DIR_SERIALIZER = new ValueSerializer<long[][]>()
    {
        @Override
        ...
        @Override
        public long[][] deserialize( DataInput in, int available )
            throws IOException
        {
    ...
    public HTreeMapImpl( Engine engine, long counterRecid, int hashSalt, long[] segmentRecids,
                     ValueSerializer<K> keySerializer, ValueSerializer<V> valueSerializer,
...
//                        counter++;
    ...
    protected class KeySet extends AbstractSet<K>
    {
        ...
        {
            return HTreeMapImpl.this.containsKey( o );
        }
        ...
        {
            if( HTreeMapImpl.this.hasValues )
            {
                throw new UnsupportedOperationException();
            }
            else
            {
                return HTreeMapImpl.this.put( k, (V) BTreeMapImpl.EMPTY ) == null;
            }
        }
...
//            }
            return HTreeMapImpl.this.remove( o ) != null;
        }
    ...
    private final Collection<V> _values = new AbstractCollection<V>()
    {
        ...
        public boolean contains( Object o )
        {
            return HTreeMapImpl.this.containsValue( o );
        }
    ...
    abstract class HashIterator
    {
        ...
        public void remove()
        {
            ...
            HTreeMapImpl.this.remove( keyToRemove );
        }
    ...
    class Entry2 implements Entry<K, V>
    {
        ...
        public V getValue()
        {
            return HTreeMapImpl.this.get( key );
        }

        @Override
        public V setValue( V value )
        {
            return HTreeMapImpl.this.put( key, value );
        }
        ...
        public int hashCode()
        {
            final V value = HTreeMapImpl.this.get( key );
    ...
    public V putIfAbsent( K key, V value )
    {
        ...
        try
        {
            ...
            LinkedNode<K, V> ln = HTreeMapImpl.this.getInner( key, h, segment );
            if( ln == null )
            {
    ...
    protected static final class ExpireLinkNode
    {
        ...
        public static final ValueSerializer<ExpireLinkNode> SERIALIZER = new ValueSerializer<ExpireLinkNode>()
        {
            @Override
            public void serialize( DataOutput out, ExpireLinkNode value )
                throws IOException
            {
                if( value == EMPTY )
                {
            ...
            @Override
            public ExpireLinkNode deserialize( DataInput in, int available )
                throws IOException
            {
                if( available == 0 )
                {
    ...
    @Override public Map<K, V> snapshot()
    {
        ...
        return new HTreeMapImpl<K, V>( snapshot, counter == null ? 0 : counter.recid,
...
//            expireCheckSegment(seg);
    ...
    protected static class ExpireRunnable implements Runnable
    {
        ...
        public ExpireRunnable( HTreeMapImpl map )
        {
