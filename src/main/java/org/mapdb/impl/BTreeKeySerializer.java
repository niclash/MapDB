 ...
 * @param <K> type of key
 */
public abstract class BTreeKeySerializer<K> implements KeySerializer<K>
{
     ...
     * @throws IOException
     */
    public abstract void serialize( DataOutput out, int start, int end, Object[] keys )
        throws IOException;
     ...
     * @throws IOException
     */
    public abstract Object[] deserialize( DataInput in, int start, int end, int size )
        throws IOException;
    ...
    public static final KeySerializer BASIC = new BTreeKeySerializer.BasicKeySerializer( SerializerBase.BASIC );
    ...
    public static final class BasicKeySerializer extends BTreeKeySerializer<Object> implements Serializable
    {
        ...
        protected final ValueSerializer defaultSerializer;

        public BasicKeySerializer( ValueSerializer defaultSerializer )
        {
         ...
         */
        protected BasicKeySerializer( SerializerBase serializerBase,
                                      DataInput is,
            ...
            throws IOException
        {
            ...
            defaultSerializer = (ValueSerializer) serializerBase.deserialize( is, objectStack );
        }
     ...
     * number.
     */
    public static final KeySerializer<Long> ZERO_OR_POSITIVE_LONG = new BTreeKeySerializer<Long>()
    {
        @Override
        public void serialize( DataOutput out, int start, int end, Object[] keys )
            throws IOException
        ...
        {
            return BTreeMapImpl.COMPARABLE_COMPARATOR;
        }
    };
     ...
     * number.
     */
    public static final KeySerializer<Integer> ZERO_OR_POSITIVE_INT = new BTreeKeySerializer<Integer>()
    {
        @Override
        public void serialize( DataOutput out, int start, int end, Object[] keys )
            throws IOException
     ...
     */
    public static final KeySerializer<String> STRING = new BTreeKeySerializer<String>()
    {
     ...
     * author: Kevin Day
     */
    public static byte[] leadingValuePackRead( DataInput in, byte[] previous, int ignoreLeadingCount )
        throws IOException
    {
     ...
     * author: Kevin Day
     */
    public static void leadingValuePackWrite( DataOutput out, byte[] buf, byte[] previous, int ignoreLeadingCount )
        throws IOException
    {
        if( buf == null )
        {
        ...
        implements Serializable
    {
        ...
        protected final ValueSerializer<A> aSerializer;
        protected final ValueSerializer<B> bSerializer;
         ...
         */
        public Tuple2KeySerializer( Comparator<A> aComparator,
                                    ValueSerializer<A> aSerializer,
                                    ValueSerializer<B> bSerializer
        )
        {
         ...
         */
        Tuple2KeySerializer( SerializerBase serializerBase,
                             DataInput is,
                             SerializerBase.FastArrayList<Object> objectStack,
                             int extra
        )
            throws IOException
        {
            ...
            aSerializer = (ValueSerializer<A>) serializerBase.deserialize( is, objectStack );
            bSerializer = (ValueSerializer<B>) serializerBase.deserialize( is, objectStack );
        }

        @SuppressWarnings( "unchecked" )
        public Tuple2KeySerializer( Tuple2KeySerializer<A, B> s,
                                    ValueSerializer defaultSerializer
        )
        {
            aComparator = s.aComparator != null ? s.aComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            aSerializer = s.aSerializer != null ? s.aSerializer : defaultSerializer;
            bSerializer = s.bSerializer != null ? s.bSerializer : defaultSerializer;
        }
    ...
    public static class Tuple3KeySerializer<A, B, C> extends BTreeKeySerializer<Fun.Tuple3<A, B, C>> implements Serializable
    {
        ...
        protected final ValueSerializer<A> aSerializer;
        protected final ValueSerializer<B> bSerializer;
        protected final ValueSerializer<C> cSerializer;
         ...
         */
        public Tuple3KeySerializer( Comparator<A> aComparator,
                                    Comparator<B> bComparator,
                                    ValueSerializer<A> aSerializer,
                                    ValueSerializer<B> bSerializer,
                                    ValueSerializer<C> cSerializer
        )
        {
            this.aComparator = aComparator;
         ...
         * used for deserialization
         */
        Tuple3KeySerializer( SerializerBase serializerBase,
                             DataInput is,
                             SerializerBase.FastArrayList<Object> objectStack
        )
            throws IOException
        {
            ...
            aSerializer = (ValueSerializer<A>) serializerBase.deserialize( is, objectStack );
            bSerializer = (ValueSerializer<B>) serializerBase.deserialize( is, objectStack );
            cSerializer = (ValueSerializer<C>) serializerBase.deserialize( is, objectStack );
        }

        @SuppressWarnings( "unchecked" )
        public Tuple3KeySerializer( Tuple3KeySerializer<?, ?, ?> s,
                                    ValueSerializer defaultSerializer
        )
        {
            aComparator = s.aComparator != null ? s.aComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            bComparator = s.bComparator != null ? s.bComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            aSerializer = s.aSerializer != null ? s.aSerializer : defaultSerializer;
            bSerializer = s.bSerializer != null ? s.bSerializer : defaultSerializer;
            cSerializer = s.cSerializer != null ? s.cSerializer : defaultSerializer;
        }
    ...
    public static class Tuple4KeySerializer<A, B, C, D> extends BTreeKeySerializer<Fun.Tuple4<A, B, C, D>> implements Serializable
    {
        ...
        protected final ValueSerializer<B> bSerializer;
        protected final ValueSerializer<C> cSerializer;
        protected final ValueSerializer<D> dSerializer;
         ...
         */
        public Tuple4KeySerializer( Comparator<A> aComparator,
                                    Comparator<B> bComparator,
                                    Comparator<C> cComparator,
                                    ValueSerializer<A> aSerializer,
                                    ValueSerializer<B> bSerializer,
                                    ValueSerializer<C> cSerializer,
                                    ValueSerializer<D> dSerializer
        )
        {
            this.aComparator = aComparator;
            this.bComparator = bComparator;
         ...
         * used for deserialization
         */
        Tuple4KeySerializer( SerializerBase serializerBase,
                             DataInput is,
                             SerializerBase.FastArrayList<Object> objectStack
        )
            throws IOException
        {
            ...
            bSerializer = (ValueSerializer<B>) serializerBase.deserialize( is, objectStack );
            cSerializer = (ValueSerializer<C>) serializerBase.deserialize( is, objectStack );
            dSerializer = (ValueSerializer<D>) serializerBase.deserialize( is, objectStack );
        }

        @SuppressWarnings( "unchecked" )
        public Tuple4KeySerializer( Tuple4KeySerializer<?, ?, ?, ?> s, ValueSerializer defaultSerializer )
        {
            aComparator = s.aComparator != null ? s.aComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            bComparator = s.bComparator != null ? s.bComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            cComparator = s.cComparator != null ? s.cComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            aSerializer = s.aSerializer != null ? s.aSerializer : defaultSerializer;
            bSerializer = s.bSerializer != null ? s.bSerializer : defaultSerializer;
            cSerializer = s.cSerializer != null ? s.cSerializer : defaultSerializer;
            dSerializer = s.dSerializer != null ? s.dSerializer : defaultSerializer;
        }
    ...
    public static class Tuple5KeySerializer<A, B, C, D, E> extends BTreeKeySerializer<Fun.Tuple5<A, B, C, D, E>> implements Serializable
    {
        ...
        protected final ValueSerializer<C> cSerializer;
        protected final ValueSerializer<D> dSerializer;
        protected final ValueSerializer<E> eSerializer;

        /**
         * Construct new Tuple4 Key Serializer. You may pass null for some value,
         * In that case 'default' value will be used, Comparable comparator and Default Serializer from DB.
         */
        public Tuple5KeySerializer( Comparator<A> aComparator,
                                    Comparator<B> bComparator,
                                    Comparator<C> cComparator,
         ...
         * used for deserialization
         */
        Tuple5KeySerializer( SerializerBase serializerBase,
                             DataInput is,
                             SerializerBase.FastArrayList<Object> objectStack
        )
            throws IOException
        {
            ...
            cSerializer = (ValueSerializer<C>) serializerBase.deserialize( is, objectStack );
            dSerializer = (ValueSerializer<D>) serializerBase.deserialize( is, objectStack );
            eSerializer = (ValueSerializer<E>) serializerBase.deserialize( is, objectStack );
        }

        @SuppressWarnings( "unchecked" )
        public Tuple5KeySerializer( Tuple5KeySerializer<?, ?, ?, ?, ?> s, ValueSerializer defaultSerializer )
        {
            aComparator = s.aComparator != null ? s.aComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            bComparator = s.bComparator != null ? s.bComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            cComparator = s.cComparator != null ? s.cComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            dComparator = s.dComparator != null ? s.dComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            aSerializer = s.aSerializer != null ? s.aSerializer : defaultSerializer;
            bSerializer = s.bSerializer != null ? s.bSerializer : defaultSerializer;
            cSerializer = s.cSerializer != null ? s.cSerializer : defaultSerializer;
            dSerializer = s.dSerializer != null ? s.dSerializer : defaultSerializer;
            eSerializer = s.eSerializer != null ? s.eSerializer : defaultSerializer;
        }
    ...
    public static class Tuple6KeySerializer<A, B, C, D, E, F> extends BTreeKeySerializer<Fun.Tuple6<A, B, C, D, E, F>> implements Serializable
    {
        ...
        protected final ValueSerializer<D> dSerializer;
        protected final ValueSerializer<E> eSerializer;
        protected final ValueSerializer<F> fSerializer;

        /**
         * Construct new Tuple4 Key Serializer. You may pass null for some value,
         * In that case 'default' value will be used, Comparable comparator and Default Serializer from DB.
         */
        public Tuple6KeySerializer( Comparator<A> aComparator,
                                    Comparator<B> bComparator,
                                    Comparator<C> cComparator,
                                    Comparator<D> dComparator,
         ...
         * used for deserialization
         */
        Tuple6KeySerializer( SerializerBase serializerBase,
                             DataInput is,
                             SerializerBase.FastArrayList<Object> objectStack
        )
            throws IOException
        {
            ...
            dSerializer = (ValueSerializer<D>) serializerBase.deserialize( is, objectStack );
            eSerializer = (ValueSerializer<E>) serializerBase.deserialize( is, objectStack );
            fSerializer = (ValueSerializer<F>) serializerBase.deserialize( is, objectStack );
        }

        @SuppressWarnings( "unchecked" )
        public Tuple6KeySerializer( Tuple6KeySerializer<?, ?, ?, ?, ?, ?> s, ValueSerializer defaultSerializer )
        {
            aComparator = s.aComparator != null ? s.aComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            bComparator = s.bComparator != null ? s.bComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            cComparator = s.cComparator != null ? s.cComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            dComparator = s.dComparator != null ? s.dComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            eComparator = s.eComparator != null ? s.eComparator : BTreeMapImpl.COMPARABLE_COMPARATOR;
            aSerializer = s.aSerializer != null ? s.aSerializer : defaultSerializer;
            bSerializer = s.bSerializer != null ? s.bSerializer : defaultSerializer;
            cSerializer = s.cSerializer != null ? s.cSerializer : defaultSerializer;
            dSerializer = s.dSerializer != null ? s.dSerializer : defaultSerializer;
            eSerializer = s.eSerializer != null ? s.eSerializer : defaultSerializer;
            fSerializer = s.fSerializer != null ? s.fSerializer : defaultSerializer;
        }
