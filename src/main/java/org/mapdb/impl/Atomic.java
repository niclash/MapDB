...
final public class Atomic
{
    ...
    public final static class Integer extends Number
    {
        ...
        {
            return engine.get( recid, SerializerBase.INTEGER );
        }
        ...
        {
            engine.update( recid, newValue, SerializerBase.INTEGER );
        }
        ...
        {
            return engine.compareAndSwap( recid, expect, update, SerializerBase.INTEGER );
        }
    ...
    public final static class Long extends Number
    {
        ...
        {
            return engine.get( recid, SerializerBase.LONG );
        }
        ...
        {
            engine.update( recid, newValue, SerializerBase.LONG );
        }
        ...
        {
            return engine.compareAndSwap( recid, expect, update, SerializerBase.LONG );
        }
    ...
    public final static class Boolean
    {
        ...
        {
            return engine.get( recid, SerializerBase.BOOLEAN );
        }
        ...
        {
            return engine.compareAndSwap( recid, expect, update, SerializerBase.BOOLEAN );
        }
        ...
        {
            engine.update( recid, newValue, SerializerBase.BOOLEAN );
        }
    ...
    public final static class String
    {
        ...
        {
            return engine.get( recid, SerializerBase.STRING_NOSIZE );
        }
        ...
        {
            return engine.compareAndSwap( recid, expect, update, SerializerBase.STRING_NOSIZE );
        }
        ...
        {
            engine.update( recid, newValue, SerializerBase.STRING_NOSIZE );
        }
    ...
    public static final class Var<E>
    {
        ...
        public Var( Engine engine, long recid, ValueSerializer<E> serializer )
        {
            this.engine = engine;
            this.recid = recid;
