...
public class SerializerBase implements ValueSerializer<Object>
{
    ...
    private void serialize2(DataOutput out, Object obj, FastArrayList<Object> objectStack, Class<?> clazz) throws IOException {
        ...
        if(obj instanceof Atomic.Long ){
            ...
            DataOutput2.packLong(out,((Atomic.Long) obj).getRecid());
            return;
        }else if(obj instanceof Atomic.Integer ){
            out.write(Header.MA_INT);
            DataOutput2.packLong(out, ((Atomic.Integer) obj).getRecid());
            return;
        }else if(obj instanceof Atomic.Boolean ){
            out.write(Header.MA_BOOL);
            DataOutput2.packLong(out, ((Atomic.Boolean) obj).getRecid());
            return;
        }else if(obj instanceof Atomic.String ){
            out.write(Header.MA_STRING);
            DataOutput2.packLong(out, ((Atomic.String) obj).getRecid());
            return;
        } else if(obj == this){
            out.write(Header.MAPDB);
    ...
    protected static final class singletons{
        ...
        static {
            ...
            all.put( InternalSerializers.STRING_NOSIZE,HeaderMapDB.SERIALIZER_STRING_NOSIZE);
            all.put( InternalSerializers.STRING_ASCII,HeaderMapDB.SERIALIZER_STRING_ASCII);
            all.put( InternalSerializers.STRING_INTERN,HeaderMapDB.SERIALIZER_STRING_INTERN);
            all.put( InternalSerializers.LONG,HeaderMapDB.SERIALIZER_LONG);
            all.put( InternalSerializers.INTEGER,HeaderMapDB.SERIALIZER_INT);
            all.put( InternalSerializers.ILLEGAL_ACCESS,HeaderMapDB.SERIALIZER_ILLEGAL_ACCESS);
            all.put( InternalSerializers.BASIC,HeaderMapDB.SERIALIZER_BASIC);
            all.put( InternalSerializers.BOOLEAN,HeaderMapDB.SERIALIZER_BOOLEAN);
            all.put( InternalSerializers.BYTE_ARRAY_NOSIZE,HeaderMapDB.SERIALIZER_BYTE_ARRAY_NOSIZE);
            all.put( InternalSerializers.BYTE_ARRAY,HeaderMapDB.BYTE_ARRAY_SERIALIZER);
            all.put( InternalSerializers.JAVA,HeaderMapDB.SERIALIZER_JAVA);
            all.put( InternalSerializers.UUID,HeaderMapDB.SERIALIZER_UUID);
            all.put( InternalSerializers.STRING,HeaderMapDB.SERIALIZER_STRING);
            all.put( InternalSerializers.CHAR_ARRAY,HeaderMapDB.SERIALIZER_CHAR_ARRAY);
            all.put( InternalSerializers.INT_ARRAY,HeaderMapDB.SERIALIZER_INT_ARRAY);
            all.put( InternalSerializers.LONG_ARRAY,HeaderMapDB.SERIALIZER_LONG_ARRAY);
            all.put( InternalSerializers.DOUBLE_ARRAY,HeaderMapDB.SERIALIZER_DOUBLE_ARRAY);
