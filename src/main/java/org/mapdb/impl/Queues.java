...
public final class Queues {
    ...
    public static abstract class SimpleQueue<E> implements BlockingQueue<E> {
        ...
        protected static class NodeSerializer<E> implements ValueSerializer<Node<E>>
        {
    ...
    public static class Queue<E> extends SimpleQueue<E> {
        ...
        public Queue(Engine engine, ValueSerializer<E> serializer, long headerRecid,
    ...
    public static class CircularQueue<E> extends SimpleQueue<E> {
        ...
        public CircularQueue(Engine engine, ValueSerializer<E> serializer, long headRecid, long headInsertRecid, long size) {
