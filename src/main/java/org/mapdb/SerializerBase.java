...
public class SerializerBase implements Serializer<Object>{
    ...
    private void serialize2(DataOutput out, Object obj, FastArrayList<Object> objectStack, Class<?> clazz) throws IOException {
        ...
        if (obj instanceof Object[]) {
            ...
            out.write(Header.MAPDB);
            DataIO.packInt(out, HeaderMapDB.SERIALIZER_KEY_TUPLE3);
            ...
            out.write(Header.MAPDB);
            DataIO.packInt(out, HeaderMapDB.SERIALIZER_KEY_TUPLE4);
            ...
            out.write(Header.MAPDB);
            DataIO.packInt(out, HeaderMapDB.SERIALIZER_KEY_TUPLE5);
            ...
            out.write(Header.MAPDB);
            DataIO.packInt(out, HeaderMapDB.SERIALIZER_KEY_TUPLE6);
