...
public interface DBBuilder
{
    ...
    DBBuilder newMemoryDB();

    DBBuilder newMemoryDirectDB();

    DBBuilder newAppendFileDB( File file );

    DBBuilder newFileDB( File file );
     ...
     * @return this builder
     */
    DBBuilder cacheCondition( Fun.RecordCondition cacheCondition );
     ...
     */
    DBBuilder mmapFileEnablePartial();
     ...
     */
    DBBuilder mmapFileEnableIfSupported();
     ...
     * @return this builder
     */
    DBBuilder cacheSize( int cacheSize );
     ...
     * @return this builder
     */
    DBBuilder asyncWriteFlushDelay( int delay );
     ...
     * @return this builder
     */
    DBBuilder asyncWriteQueueSize( int queueSize );
     ...
     * @return this builder
     */
    DBBuilder deleteFilesAfterClose();
     ...
     * @return this builder
     */
    DBBuilder freeSpaceReclaimQ( int q );
     ...
     * @return this builder
     */
    DBBuilder commitFileSyncDisable();
     ...
     * @return this builder
     */
    DBBuilder sizeLimit( double maxSize );
     ...
     * @return this builder
     */
    DBBuilder encryptionEnable( String password );
